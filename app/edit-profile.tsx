...
// PERBAIKAN IMPORT: Cukup mundur satu langkah (..) atau sejajar (.)
...
export default function EditProfileScreen() {
    ...
    const handleUpdateProfile = async () => {
        if (!user) {
            Alert.alert("Error", "Anda tidak sedang login.");
            return;
        }
        if (!name.trim()) {
...
const styles = StyleSheet.create({
    ...
    submitButton: { marginTop: 10, backgroundColor: Colors.primary, padding: 18, borderRadius: 15, alignItems: 'center' },
